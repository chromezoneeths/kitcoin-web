...
let path = localStorage.getItem("overrideURL") || `${window.location.protocol === "https:" ? 'wss://' : 'ws://'}${window.location.host}/oauth`; // oauth is the only path guaranteed to be forwarded to kitcoin.
(async () => {
